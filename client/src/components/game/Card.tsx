...
export function Card({ 
  ...
  return (
    <ShadcnCard
      className={cn(
        "flex items-center justify-center p-5 cursor-pointer min-h-[60px] rounded-[16px] border-2 border-b-4 active:border-b-2 active:mt-[2px] [transition:border_0.4s,transform_0.4s,margin_0.4s] active:translate-y-[2px] active:[transition:none]",
        styles.background,
        styles.border,
