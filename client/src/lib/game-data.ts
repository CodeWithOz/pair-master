...
export const wordPairs: CreateWordPair[] = [
  ...
  { english: "small cute cat", german: "Kätzchen" },
  ...
  { english: "small cute dog", german: "Hündchen" },
  { english: "small cute town", german: "Städtchen" },
  { english: "breakfast", german: "Frühstück" },
  { english: "reservation", german: "Reservierung" },
  { english: "influenza", german: "Gliederschmerzen" },
  { english: "Mitglied", german: "member" },
  ...
  { english: "explanation", german: "Erläuterung" },
